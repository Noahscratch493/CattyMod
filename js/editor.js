...
, {
  ...
  href: "https://cattymod.github.io/ImproveMyScratch/"
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  render() {
    ...
    // eslint-disable-next-line max-len
    , {
      defaultMessage: "CattyMod is a Scratch mod that compiles projects to JavaScript to make them run really fast. Try it out by inputting a project ID or URL above or choosing a featured project below.",
